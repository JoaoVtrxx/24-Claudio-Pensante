...
import 'schema/diarios_record.dart';
...
export 'schema/diarios_record.dart';
...
/// Functions to query DiariosRecords (as a Stream and as a Future).
Future<int> queryDiariosRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DiariosRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DiariosRecord>> queryDiariosRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      DiariosRecord.collection,
      DiariosRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DiariosRecord>> queryDiariosRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
